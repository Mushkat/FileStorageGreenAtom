package com.test.filestoragegreen.controller;

import com.test.filestoragegreen.model.FileEntity;
import com.test.filestoragegreen.model.FileResponse;
import com.test.filestoragegreen.service.FileService;
...
public class FilesController {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK)
                    .body(String.format("File uploaded successfully: %s" +
                            "\nIt's id is: %s", file.getOriginalFilename(), id));
        } catch (Exception e) {
    ...
    public ResponseEntity<byte[]> getFile(@PathVariable String id) {
        Optional<FileEntity> fileEntityOptional = fileService.findFileById(id);
